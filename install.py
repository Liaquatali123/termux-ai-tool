...
def main():
    ...
    ok("Aliases added: ai-status, ai-models, ai-scan, ai-sync, ai-chat")
    ...
    print("  6. Launch full-screen AI Chat:")
    print("     termux-ai tui  (or: ai-chat)\n")
